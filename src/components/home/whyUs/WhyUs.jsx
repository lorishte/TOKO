		...
		return (
			<div id="why-us" className="container bg-white">
				...
				<article className="article">
					...
					<h2 className="article-headline">Истинско еспресо</h2>
				</article>
				...
				<article className="article">
					...
					<h2 className="article-headline">Безплатна машина</h2>
				</article>
				...
				<article className="article">
					...
					<h2 className="article-headline">Безплатна поддръжка на машината</h2>
				</article>
				...
				<article className="article">
					...
					<h2 className="article-headline">Безплатна доставка на кафе и необходимите консумативи</h2>
				</article>
